...
export default class Game extends GameEngine {
    ...
    processInput(inputData, playerId) {
        ...
        if (playerPaddle) {
            ...
            playerPaddle.position.y = Math.max(0, Math.min(HEIGHT, playerPaddle.position.y));
        }
    }
    ...
    clientSideInit() {
        ...
        r.paddle1.graphics.beginFill('black').drawRect(0, 0, PADDLE_WIDTH, PADDLE_HEIGHT);
        r.paddle2.graphics.beginFill('black').drawRect(0, 0, PADDLE_WIDTH, PADDLE_HEIGHT);
